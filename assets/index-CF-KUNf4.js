...
`,Y=({label:i,type:s,id:l,placeholder:a,register:d})=>e.jsxs(li,{children:[e.jsx("label",{children:i}),e.jsx("input",{type:s,id:l,...d&&d(l),placeholder:a,autoComplete:"off"})]}),E=({type:i,id:s,register:l,placeholder:a})=>e.jsx(ri,{type:i,id:s,...l&&l(s),placeholder:a,autoComplete:"off"}),D=({label:i,type:s,id:l,placeholder:a})=>e.jsxs(di,{children:[e.jsx("label",{htmlFor:l,children:i}),e.jsx("input",{type:s,id:l,placeholder:a,autoComplete:"off"})]}),A=({label:i,type:s,id:l,required:a})=>e.jsxs(oi,{children:[e.jsxs("label",{htmlFor:l,className:"label",children:[e.jsx("span",{className:"txt",children:i}),a&&e.jsx("span",{className:"req",children:" *"})]}),e.jsx("div",{className:"input_area",children:e.jsx("input",{type:s,id:l,autoComplete:"off",className:"input"})})]}),pi=n.div`
  width: 100%;
  & input {
    display: none;
  }
...
`,j=({label:i,id:s,register:l,required:a})=>e.jsxs(ci,{className:"InputCheckboxA",children:[e.jsx("input",{required:!0,type:"checkbox",id:s,...l&&l(s)}),e.jsxs("label",{htmlFor:s,children:[i,a&&e.jsx("span",{className:"req",children:" *"})]})]}),v=({label:i,id:s,register:l,onChange:a})=>e.jsxs(hi,{children:[e.jsx("input",{type:"checkbox",id:s,...l&&l(s),onChange:a,value:i}),e.jsx("label",{htmlFor:s,children:i})]}),mi=n.div`
  pointer-events: all;
  width: 100%;
  position: relative;
`,gi=n.div`
...
`,zt=()=>e.jsxs(Et,{children:[e.jsxs(Lt,{children:[e.jsxs("div",{children:[e.jsx("span",{className:"label",children:"이름"}),e.jsx("span",{className:"info",children:"김고은"})]}),e.jsxs("div",{children:[e.jsx("span",{className:"label",children:"이메일(ID)"}),e.jsx("span",{className:"info",children:"abcd@mindsground.com"})]}),e.jsxs("div",{children:[e.jsx("span",{className:"label",children:"기업명"}),e.jsx("span",{className:"info",children:"마인즈그라운드"})]})]}),e.jsxs(Mt,{children:[e.jsx(D,{label:"전화번호",type:"tel",id:"phone",placeholder:"전화번호를 입력하세요"}),e.jsx(D,{label:"비밀번호 변경",type:"password",id:"changePassword",placeholder:"비밀번호를 입력하세요"}),e.jsxs("div",{className:"radio_box",children:[e.jsx("p",{className:"label",children:"성별"}),e.jsx(u,{label:"남",id:"man",name:"gender",defaultChecked:!0}),e.jsx(u,{label:"여",id:"woman",name:"gender"})]}),e.jsx(D,{label:"생년월일",type:"date",id:"birth",placeholder:"생년월일을 입력하세요"}),e.jsxs("div",{className:"favorite_box",children:[e.jsx("p",{className:"label",children:"관심분야"}),e.jsx("div",{className:"favorite_list",children:V1.favoriteList.map(i=>e.jsx(j,{label:i.label,id:i.id},i.id))})]}),e.jsxs(Vt,{children:[e.jsx("button",{className:"submit_btn",children:"저장"}),e.jsx(r,{to:"/mypage/user-modify/with-draw",children:"마이스 메이트 탈퇴하기"})]})]})]}),Zt=n.div`
  padding: 20px 0 0;
  position: relative;
`,St=n.div`
