import{r as i,j as e}from"./react-CEomBadl.js";import{c as Ne}from"./react-dom-DzXLT4xP.js";import{R as Me,a as D,b as He}from"./recoil-CRP-MDfr.js";import{L as o,c as ze,R as Se}from"./react-router-dom-CBFYaWWZ.js";import{d as n,f as Ze}from"./styled-components-DB29_VXG.js";import{d as S,O as he,c as me}from"./react-router-dpmnM8iX.js";import{u as Z}from"./usehooks-ts-VOMI3imE.js";import{S as V,A as Ve,N as W,P as Ae,a as A}from"./swiper-Pt6sIOtf.js";import{u as Y}from"./react-hook-form-DxDPgmXM.js";import{t as J}from"./@hookform-WvXEGqmR.js";import{o as U,s as u,c as Re,l as Be,Z as Ie}from"./zod-eJtvhOw1.js";import{r as Fe}from"./styled-reset-BBMsiTzG.js";import"./lodash.debounce-DnXNXokw.js";import"./scheduler-CzFDRTuY.js";import"./@remix-run-BHHfG7hN.js";import"./@emotion-sScrWPmR.js";import"./stylis-DinRj2j6.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))r(l);new MutationObserver(l=>{for(const d of l)if(d.type==="childList")for(const p of d.addedNodes)p.tagName==="LINK"&&p.rel==="modulepreload"&&r(p)}).observe(document,{childList:!0,subtree:!0});function s(l){const d={};return l.integrity&&(d.integrity=l.integrity),l.referrerPolicy&&(d.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?d.credentials="include":l.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function r(l){if(l.ep)return;l.ep=!0;const d=s(l);fetch(l.href,d)}})();const Q=Me({key:"user",default:{isLogin:!0,isLoginError:!1}}),Oe=n.div`
  position: fixed;
  top: 0;
  right: 0;
  bottom: 0;
...
`,q=t=>i.createElement("svg",{width:16,height:16,viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg",...t},i.createElement("rect",{x:1.52344,width:20.4717,height:2.15492,rx:1,transform:"rotate(45 1.52344 0)",fill:"white"}),i.createElement("rect",{x:16,y:1.52344,width:20.4717,height:2.15492,rx:1,transform:"rotate(135 16 1.52344)",fill:"white"})),pe=({children:t,setClose:a})=>{const r=D(Q).isLogin,l=()=>{a(!1),document.body.style.overflow="auto"};return e.jsxs(Oe,{children:[e.jsxs(Pe,{children:[r&&e.jsx("div",{className:"user_name",children:"o o o 님"}),e.jsx("button",{onClick:()=>l(),className:"close_btn",children:e.jsx(q,{})})]}),e.jsx(Te,{children:t})]})},De=n.header`
...
`;const ut=t=>i.createElement("svg",{width:16,height:9,viewBox:"0 0 16 9",fill:"none",xmlns:"http://www.w3.org/2000/svg",...t},i.createElement("path",{d:"M1 1L8 8L15 1",stroke:"white",strokeOpacity:.5,strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"})),bt=()=>{const[t,a]=i.useState(!1),s=S(),r=[{id:"00",name:"참여 행사 관리",type:"toggleButton",subMenu:[{id:"00-00",path:"/mypage/apply-list",name:"신청 행사"},{id:"00-01",path:"/mypage/cancel-list",name:"취소 내역"},{id:"00-02",path:"/mypage/wish-list",name:"관심 행사"},{id:"00-03",path:"/mypage/past-list",name:"지난 행사"}]},{id:"01",path:"/mypage/user-modify",name:"내 정보 수정"},{id:"02",name:"로그아웃",type:"button"}],l=()=>{a(d=>!d)};return i.useEffect(()=>{s.pathname!=="/mypage/user-modify"&&a(!0)},[s.pathname]),e.jsxs(gt,{children:[e.jsx("h2",{children:"마이페이지"}),e.jsx(ft,{children:r.map(d=>d.type==="toggleButton"?e.jsxs("div",{children:[e.jsxs(z,{onClick:l,$isOn:t,children:["참여 행사 관리",e.jsx("span",{children:e.jsx(ut,{})})]}),e.jsx(wt,{$isOn:t,children:d.subMenu&&d.subMenu.map(p=>e.jsx(z,{$target:s.pathname.indexOf(p.path)>=0,children:e.jsx(o,{to:p.path,children:p.name})},p.id))})]},d.id):d.type!=="button"?e.jsx(z,{$target:!!(d.path&&s.pathname.indexOf(d.path)>=0),children:e.jsx(o,{to:d.path,children:d.name})},d.id):e.jsx(z,{children:d.name},d.id))})]})},jt=n.div`
  position: relative;
  display: flex;
...
`,Nt=({bannerImgs:t})=>e.jsx(Lt,{children:e.jsx(V,{slidesPerView:1.05,centeredSlides:!0,spaceBetween:5,navigation:!0,pagination:!0,modules:[Ve,W,Ae],loop:!0,autoplay:{delay:5e3,disableOnInteraction:!1},breakpoints:{1024:{spaceBetween:24}},className:"main_swiper",children:t&&t.map((a,s)=>e.jsx(A,{children:e.jsx("figure",{children:e.jsx("img",{src:a,alt:`메인배너_${s}`})})},s))})}),Mt=n.div`
  padding: 160px 0 0;
  @media (max-width: 1024px) {
    padding: 0;
  }
...
`,T=({label:t,type:a,id:s,placeholder:r,register:l})=>e.jsxs(_t,{children:[e.jsx("label",{children:t}),e.jsx("input",{type:a,id:s,...l&&l(s),placeholder:r,autoComplete:"off"})]}),L=({type:t,id:a,register:s,placeholder:r})=>e.jsx(Gt,{type:t,id:a,...s&&s(a),placeholder:r,autoComplete:"off"}),O=({label:t,type:a,id:s,placeholder:r})=>e.jsxs(Xt,{children:[e.jsx("label",{htmlFor:s,children:t}),e.jsx("input",{type:a,id:s,placeholder:r,autoComplete:"off"})]}),Kt=n.div`
  width: 100%;
  & input {
    display: none;
  }
...
`,ce=({label:t,id:a,name:s,register:r})=>e.jsxs(Kt,{children:[e.jsx("input",{type:"radio",id:a,value:a,...r&&r(s)}),e.jsx("label",{htmlFor:a,children:t})]}),f=({label:t,id:a,name:s,register:r,defaultChecked:l})=>e.jsxs($t,{children:[e.jsx("input",{type:"radio",id:a,value:a,name:s,...r&&r(s),defaultChecked:l}),e.jsx("label",{htmlFor:a,children:t})]}),ei=n.div`
  & input {
    display: none;
  }
  & label {
...
`,K=({label:t,id:a,register:s})=>e.jsxs(ei,{children:[e.jsx("input",{type:"checkbox",id:a,...s&&s(a)}),e.jsx("label",{htmlFor:a,children:t})]}),C=({label:t,id:a,register:s,onChange:r})=>e.jsxs(ti,{children:[e.jsx("input",{type:"checkbox",id:a,...s&&s(a),onChange:r,value:t}),e.jsx("label",{htmlFor:a,children:t})]}),ii=n.div`
  pointer-events: all;
  width: 100%;
  position: relative;
`,ni=n.div`
...
`;n.li`
  ...
  line-height: 18px;
  letter-spacing: -0.001em;
`;const si=t=>i.createElement("svg",{width:14,height:8,viewBox:"0 0 14 8",fill:"none",xmlns:"http://www.w3.org/2000/svg",...t},i.createElement("path",{d:"M13 1L7 7L1 0.999999",stroke:"#9B9B9B",strokeLinecap:"round",strokeLinejoin:"round"})),oi=({text:t,children:a})=>{const[s,r]=i.useState(!1),l=()=>{r(d=>!d)};return e.jsxs(ii,{children:[e.jsxs(ni,{onClick:l,$isOn:s,children:[t,e.jsx("span",{children:e.jsx(si,{})})]}),e.jsx(ai,{$isOn:s,children:a})]})},ri=n.ul`
  display: flex;
  gap: 8px;
  flex-wrap: wrap;
`,li=n.li`
...
`,di=t=>i.createElement("svg",{width:8,height:8,viewBox:"0 0 8 8",fill:"none",xmlns:"http://www.w3.org/2000/svg",...t},i.createElement("path",{d:"M1.34375 1L6.95181 7",stroke:"#1E9EFF",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round"}),i.createElement("path",{d:"M6.95117 1L1.34311 7",stroke:"#1E9EFF",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round"})),ve=({hashList:t,onClick:a})=>e.jsx(ri,{children:t.map((s,r)=>e.jsxs(li,{children:[e.jsx("span",{onClick:()=>a(s.id),className:"close_btn",children:e.jsx(di,{})}),e.jsx("span",{className:"label",children:s.label})]},r))}),pi=n.div`
  padding: 94px 0 57px;
...
`,fi=[{id:"field_01",label:"농축산/식음료"},{id:"field_02",label:"뷰티/화장품"},{id:"field_03",label:"에너지/환경"},{id:"field_04",label:"금융/부동산"},{id:"field_05",label:"섬유/의류"},{id:"field_06",label:"교육"},{id:"field_07",label:"금속/기계"},{id:"field_08",label:"임신/출산/육아"},{id:"field_09",label:"보건/의료"},{id:"field_10",label:"웨딩"},{id:"field_11",label:"건설/건축"},{id:"field_12",label:"문화/예술"},{id:"field_13",label:"가정용품"},{id:"field_14",label:"레저/관광"}],ke={favoriteList:fi},wi=U({email:u().email({message:"올바른 이메일을 입력해주세요."}),password:u().trim().regex(/^(?=.*[a-zA-Z])(?=.*[0-9]).{8,25}$/," 영문,숫자조합 8자리 이상 입력해주세요."),passwordChk:u().trim().min(1,"비밀번호를 확인해주세요."),name:u(),birth:Re.number().gte(8),gender:u(),agree_01:Be(!0)}).superRefine(({passwordChk:t,password:a},s)=>{t!==a&&s.addIssue({code:Ie.custom,message:"비밀번호를 확인해주세요.",path:["passwordChk"]})}),ui=()=>{var x,g,w,y,$,ee,te,ie,ne,ae,se,oe,re,le,de;const[t,a]=i.useState([]),s=m=>{m.currentTarget.checked?(d("agree_01",!0),d("agree_02",!0),d("agree_03",!0),d("agree_04",!0),d("agree_05",!0)):(d("agree_01",!1),d("agree_02",!1),d("agree_03",!1),d("agree_04",!1),d("agree_05",!1))},{register:r,handleSubmit:l,setValue:d,formState:{errors:p}}=Y({resolver:J(wi)}),c=l(m=>console.log(m)),h=m=>{const B=m.currentTarget.value,I=m.currentTarget.id;m.currentTarget.checked?a(F=>[...F,{id:I,label:B}]):a(F=>F.filter(Le=>console.log(Le)))},j=m=>{d(m,!1),a(B=>B.filter(I=>I.id!==m))};return e.jsx(pi,{children:e.jsxs(xi,{onSubmit:c,children:[e.jsx(N,{children:e.jsx(L,{type:"text",id:"email",register:r,placeholder:"이메일(ID)"})}),((x=p.email)==null?void 0:x.message)&&e.jsx("p",{className:"err_msg",children:(w=(g=p.email)==null?void 0:g.message)==null?void 0:w.toString()}),e.jsxs(N,{className:"password",children:[e.jsx(L,{type:"password",id:"password",register:r,placeholder:"비밀번호"}),e.jsx(L,{type:"password",id:"passwordChk",register:r,placeholder:"비밀번호 확인"})]}),((y=p.password)==null?void 0:y.message)&&e.jsx("p",{className:"err_msg",children:(ee=($=p.password)==null?void 0:$.message)==null?void 0:ee.toString()}),((te=p.passwordChk)==null?void 0:te.message)&&e.jsx("p",{className:"err_msg",children:(ne=(ie=p.passwordChk)==null?void 0:ie.message)==null?void 0:ne.toString()}),e.jsx(N,{children:e.jsx(L,{type:"text",id:"name",register:r,placeholder:"이름"})}),((ae=p.name)==null?void 0:ae.message)&&e.jsx("p",{className:"err_msg",children:(oe=(se=p.name)==null?void 0:se.message)==null?void 0:oe.toString()}),e.jsxs(N,{children:[e.jsx(L,{type:"number",id:"birth",register:r,placeholder:"생년월일"}),e.jsxs(ci,{children:[e.jsx(ce,{id:"man",label:"남",name:"gender",register:r}),e.jsx(ce,{id:"woman",label:"여",name:"gender",register:r})]})]}),((re=p.name)==null?void 0:re.message)&&e.jsx("p",{className:"err_msg",children:(de=(le=p.name)==null?void 0:le.message)==null?void 0:de.toString()}),e.jsx(N,{children:e.jsx(oi,{text:"관심 분야",children:e.jsx(hi,{children:ke.favoriteList.map(m=>e.jsx(C,{label:m.label,id:m.id,register:r,onChange:h},m.id))})})}),t.length>=1&&e.jsx(ve,{hashList:t,onClick:j}),e.jsxs(mi,{children:[e.jsx(C,{label:"선택 포함 전체 약관 동의",id:"allChk",register:r,onChange:s}),e.jsxs("div",{children:[e.jsxs("div",{className:"required_box",children:[e.jsx(C,{label:"이용약관 동의 (필수)",id:"agree_01",register:r}),e.jsx("p",{className:"link",children:e.jsx(o,{to:"",children:"약관 보기"})})]}),e.jsx(C,{label:"이벤트 혜택 알림 수신 동의 (선택)",id:"agree_02",register:r}),e.jsxs("div",{className:"required_box",children:[e.jsx(C,{label:"성별, 생년 정보 제공 동의 (필수)",id:"agree_03",register:r}),e.jsx("p",{className:"link",children:e.jsx(o,{to:"",children:"내용 확인"})})]}),e.jsxs("div",{className:"required_box",children:[e.jsx(C,{label:"개인 정보 수집 및 이용 동의 (필수)",id:"agree_04",register:r}),e.jsx("p",{className:"link",children:e.jsx(o,{to:"",children:"내용 확인"})})]})]})]}),e.jsx(gi,{className:"btn",children:"회원가입"})]})})},bi=n.div`
  @media (max-width: 1024px) {
    padding: 0 16px;
  }
`,ji=n.div`
...
`,Ii=U({email:u().email({message:"올바른 이메일을 입력해주세요."})}),Fi=()=>{var c,h;const[t,a]=i.useState(!1),{register:s,handleSubmit:r,formState:{errors:l,isValid:d}}=Y({resolver:J(Ii)}),p=r(()=>a(!0));return console.log(d),e.jsxs(Vi,{children:[e.jsxs(Ai,{children:[e.jsx("h2",{children:"비밀번호 찾기"}),e.jsx("span",{children:"가입하신 이메일로 임시 비밀번호를 전송해드립니다."})]}),e.jsxs(Ri,{onSubmit:p,children:[e.jsx(T,{label:"이메일(ID)",type:"text",id:"email",placeholder:"이메일 입력",register:s}),e.jsx("p",{className:"err_msg",children:(h=(c=l.email)==null?void 0:c.message)==null?void 0:h.toString()}),e.jsx(Bi,{children:"임시 비밀번호 받기"})]}),t&&e.jsx(Ee,{text:"메일로 임시 비밀번호를 발송했습니다.",setAlret:a})]})},Oi=n.div`
  padding: 0 0 97px;
  color: #fff;
  @media (max-width: 1024px) {
    padding: 0 0 58px;
...
`,Ki=({text:t,setConfirm:a,setShowConfirm:s})=>{const[r,l]=i.useState(!1),d=()=>{a(!1),s(!1)},p=()=>{a(!0),l(!0)};return e.jsxs(e.Fragment,{children:[e.jsx(Gi,{children:e.jsxs(Xi,{children:[e.jsx("div",{className:"alret_header",children:e.jsx("button",{onClick:d,className:"close_btn",children:e.jsx(ye,{})})}),e.jsx("div",{className:"desc",children:t}),e.jsxs("div",{className:"btn_area",children:[e.jsx("button",{onClick:d,className:"secondary",children:"닫기"}),e.jsx("button",{onClick:p,className:"primary",children:"취소하기"})]})]})}),r&&e.jsx(Ee,{text:"취소가 완료되었습니다.",setAlret:s})]})},$i=({applyDate:t,state:a,title:s,date:r,location:l,linkBtn:d})=>{const[p,c]=i.useState(""),[h,j]=i.useState(!1),[x,g]=i.useState(!1);return i.useLayoutEffect(()=>{a==="apply"?c("참가 신청 완료"):a==="cancel"?c("취소 완료"):a==="wish"?c("관심 행사"):a==="past"&&c("종료 행사")},[]),e.jsxs(e.Fragment,{children:[e.jsxs(Wi,{children:[e.jsx(Yi,{children:e.jsxs(o,{to:"/detail/01",children:[(a==="cancel"||a==="past")&&e.jsx("span",{className:"blind",children:p}),e.jsx("img",{src:"./dummy_image_01.png"})]})}),e.jsxs(Ji,{children:[e.jsxs(Ui,{children:[(a==="apply"||a==="cancel")&&e.jsxs("div",{className:"apply",children:[e.jsx("span",{className:"state",children:p}),e.jsxs("span",{className:"date",children:["신청일 : ",t]})]}),e.jsxs("div",{className:"txt_box",children:[e.jsx("span",{className:"title",children:s}),e.jsx("span",{className:"date",children:r}),e.jsx("span",{className:"location",children:l})]})]}),a==="apply"&&e.jsxs(Qi,{children:[e.jsx("button",{children:"수정"}),"  |  ",e.jsx("button",{onClick:()=>{g(!0)},children:"취소"})]}),d&&e.jsxs(qi,{children:[d==="AI 추천 부스 받기"&&e.jsx(o,{to:"/mypage/apply-list/booth-select/01",children:d}),d==="AI 추천 부스 확인"&&e.jsx(o,{to:"/mypage/apply-list/booth-check/01",children:d})]}),p.length<=0&&e.jsx(_i,{children:e.jsx("button",{children:e.jsx(je,{})})})]})]}),x&&e.jsx(Ki,{text:"취소하시겠습니까? 취소 확정 후에는 복구하실 수 없습니다.",setConfirm:j,setShowConfirm:g})]})},e1=n.div`
  display: flex;
  flex-direction: column;
  gap: 30px;
  @media (max-width: 1024px) {
...
`,f1=()=>e.jsxs(c1,{children:[e.jsxs(h1,{children:[e.jsxs("div",{children:[e.jsx("span",{className:"label",children:"이름"}),e.jsx("span",{className:"info",children:"김고은"})]}),e.jsxs("div",{children:[e.jsx("span",{className:"label",children:"이메일(ID)"}),e.jsx("span",{className:"info",children:"abcd@mindsground.com"})]}),e.jsxs("div",{children:[e.jsx("span",{className:"label",children:"기업명"}),e.jsx("span",{className:"info",children:"마인즈그라운드"})]})]}),e.jsxs(m1,{children:[e.jsx(O,{label:"전화번호",type:"tel",id:"phone",placeholder:"전화번호를 입력하세요"}),e.jsx(O,{label:"비밀번호 변경",type:"password",id:"changePassword",placeholder:"비밀번호를 입력하세요"}),e.jsxs("div",{className:"radio_box",children:[e.jsx("p",{className:"label",children:"성별"}),e.jsx(f,{label:"남",id:"man",name:"gender",defaultChecked:!0}),e.jsx(f,{label:"여",id:"woman",name:"gender"})]}),e.jsx(O,{label:"생년월일",type:"date",id:"birth",placeholder:"생년월일을 입력하세요"}),e.jsxs("div",{className:"favorite_box",children:[e.jsx("p",{className:"label",children:"관심분야"}),e.jsx("div",{className:"favorite_list",children:ke.favoriteList.map(t=>e.jsx(K,{label:t.label,id:t.id},t.id))})]}),e.jsxs(g1,{children:[e.jsx("button",{className:"submit_btn",children:"저장"}),e.jsx(o,{to:"/mypage/user-modify/with-draw",children:"마이스 메이트 탈퇴하기"})]})]})]}),w1=n.div`
  padding: 20px 0 0;
  position: relative;
`,u1=n.div`
...
`,B1=t=>i.createElement("svg",{width:55,height:55,viewBox:"0 0 55 55",fill:"none",xmlns:"http://www.w3.org/2000/svg",...t},i.createElement("circle",{cx:27.5,cy:27.5,r:27.5,fill:"#3B4048"}),i.createElement("g",{clipPath:"url(#clip0_746_68963)"},i.createElement("path",{d:"M27.9999 21.6951L27.014 20.6817C24.6999 18.3029 20.4566 19.1238 18.9249 22.1144C18.2057 23.5211 18.0435 25.5519 19.3566 28.1438C20.6216 30.6394 23.2534 33.6287 27.9999 36.8847C32.7464 33.6287 35.3767 30.6394 36.6431 28.1438C37.9562 25.5506 37.7954 23.5211 37.0749 22.1144C35.5431 19.1238 31.2999 18.3016 28.9857 20.6803L27.9999 21.6951ZM27.9999 38.5416C6.91698 24.6101 21.5085 13.7366 27.7579 19.4882C27.8404 19.5638 27.9215 19.6422 27.9999 19.7233C28.0774 19.6423 28.1582 19.5643 28.2419 19.4896C34.4899 13.7338 49.0827 24.6087 27.9999 38.5416Z",fill:"white"})),i.createElement("defs",null,i.createElement("clipPath",{id:"clip0_746_68963"},i.createElement("rect",{width:22,height:22,fill:"white",transform:"translate(17 17)"})))),I1=t=>i.createElement("svg",{width:55,height:55,viewBox:"0 0 55 55",fill:"none",xmlns:"http://www.w3.org/2000/svg",...t},i.createElement("circle",{cx:27.5,cy:27.5,r:27.5,fill:"#3B4048"}),i.createElement("g",{clipPath:"url(#clip0_746_68966)"},i.createElement("path",{d:"M31.1254 20.4377C31.1253 19.6312 31.4088 18.8503 31.9263 18.2317C32.4438 17.613 33.1623 17.1961 33.9562 17.0537C34.75 16.9114 35.5687 17.0527 36.2689 17.453C36.9691 17.8533 37.5062 18.487 37.7864 19.2433C38.0665 19.9996 38.0718 20.8304 37.8013 21.5902C37.5308 22.35 37.0017 22.9905 36.3066 23.3996C35.6116 23.8088 34.7948 23.9605 33.9992 23.8282C33.2036 23.696 32.4798 23.2882 31.9545 22.6762L22.7172 26.9662C22.9296 27.6392 22.9296 28.3612 22.7172 29.0342L31.9545 33.3242C32.5098 32.6784 33.285 32.2617 34.13 32.155C34.975 32.0482 35.8295 32.2589 36.528 32.7463C37.2265 33.2336 37.7191 33.9629 37.9105 34.7929C38.1019 35.6228 37.9784 36.4942 37.5639 37.2382C37.1494 37.9823 36.4735 38.5459 35.6671 38.82C34.8607 39.0941 33.9813 39.059 33.1992 38.7216C32.4172 38.3842 31.7883 37.7686 31.4343 36.9939C31.0804 36.2192 31.0266 35.3407 31.2835 34.5287L22.0462 30.2387C21.589 30.7716 20.9794 31.1517 20.2997 31.3278C19.6199 31.5039 18.9025 31.4677 18.244 31.2238C17.5855 30.98 17.0174 30.5404 16.6162 29.9641C16.2151 29.3878 16 28.7024 16 28.0002C16 27.298 16.2151 26.6126 16.6162 26.0363C17.0174 25.46 17.5855 25.0203 18.244 24.7765C18.9025 24.5327 19.6199 24.4964 20.2997 24.6726C20.9794 24.8487 21.589 25.2288 22.0462 25.7617L31.2835 21.4717C31.1783 21.1371 31.125 20.7884 31.1254 20.4377Z",fill:"white"})),i.createElement("defs",null,i.createElement("clipPath",{id:"clip0_746_68966"},i.createElement("rect",{width:22,height:22,fill:"white",transform:"translate(16 17)"})))),F1=t=>i.createElement("svg",{width:48,height:48,viewBox:"0 0 48 48",fill:"none",xmlns:"http://www.w3.org/2000/svg",...t},i.createElement("g",{clipPath:"url(#clip0_759_23095)"},i.createElement("path",{d:"M10.8359 46.3285C9.67787 46.9225 8.36387 45.8815 8.59787 44.5525L11.0879 30.3625L0.518867 20.2945C-0.468133 19.3525 0.0448665 17.6305 1.36787 17.4445L16.0619 15.3565L22.6139 2.37555C23.2049 1.20555 24.8039 1.20555 25.3949 2.37555L31.9469 15.3565L46.6409 17.4445C47.9639 17.6305 48.4769 19.3525 47.4869 20.2945L36.9209 30.3625L39.4109 44.5525C39.6449 45.8815 38.3309 46.9225 37.1729 46.3285L23.9999 39.5605L10.8329 46.3285H10.8359Z",fill:"#1E9EFF"})),i.createElement("defs",null,i.createElement("clipPath",{id:"clip0_759_23095"},i.createElement("rect",{width:48,height:48,fill:"white"})))),O1=()=>{const[t,a]=i.useState(!0);return e.jsxs(A1,{children:[e.jsx("figure",{className:"thumb_img",children:e.jsx("img",{src:"./dummy_thumb.png"})}),e.jsxs(R1,{children:[e.jsxs("div",{className:"title_box",children:[e.jsx("h2",{children:"2024 케이펫페어 서울"}),e.jsx("p",{className:"d_day",children:"D-1"})]}),e.jsxs("div",{className:"desc_box",children:[e.jsx("span",{className:"date",children:"2024년 09월 05일 ~ 2024월 09월 08일"}),e.jsx("span",{className:"location",children:"양재 AT센터 제1전시장 A홀"})]}),e.jsxs("div",{className:"rating_box",children:[e.jsx("span",{className:"icon",children:e.jsx(F1,{})}),e.jsx("span",{className:"rating",children:"4.4"}),e.jsx("span",{className:"count",children:"(4,423)"})]}),e.jsxs("div",{className:"public_btn_box",children:[e.jsx("button",{children:e.jsx(B1,{})}),e.jsx("button",{children:e.jsx(I1,{})})]}),e.jsxs("div",{className:"apply_btn_box",children:[t&&e.jsx("button",{onClick:()=>a(s=>!s),className:"btn primary",children:"사전 신청하기"}),!t&&e.jsx("button",{onClick:()=>a(s=>!s),className:"btn disable",children:"모집이 종료되었습니다."})]})]})]})},P1=n.div`
  display: flex;
  align-items: center;
  margin-bottom: 37px;
...
`,J1=n.section``,U1=t=>i.createElement("svg",{width:29,height:30,viewBox:"0 0 29 30",fill:"none",xmlns:"http://www.w3.org/2000/svg",...t},i.createElement("path",{d:"M15.5234 16.1992L26.3234 26.9992",stroke:"#316FE9",strokeWidth:5,strokeLinecap:"round",strokeLinejoin:"round"}),i.createElement("circle",{cx:13.5,cy:13.5,r:11,stroke:"#316FE9",strokeWidth:5})),Q1=t=>i.createElement("svg",{width:29,height:30,viewBox:"0 0 29 30",fill:"none",xmlns:"http://www.w3.org/2000/svg",...t},i.createElement("path",{d:"M14.5 3L3 26.7931",stroke:"#6EA8FE",strokeWidth:5,strokeLinecap:"round",strokeLinejoin:"round"}),i.createElement("path",{d:"M14.5 3L26 26.7931",stroke:"#6EA8FE",strokeWidth:5,strokeLinecap:"round",strokeLinejoin:"round"}),i.createElement("path",{d:"M7.75781 16.8789H21.2406",stroke:"#6EA8FE",strokeWidth:5,strokeLinecap:"round",strokeLinejoin:"round"})),q1=[{f:"본 행사는 참가 시 무료인가요?",q:"사전 신청자 대상으로 무료로 제공하고 있습니다."},{f:"참가 신청 후, 티켓은 어디서 수령 받을 수 있나요?",q:"답변2"},{f:"핸드폰(전화번호)가 없는 미성년자일 경우 신청 가능한가요?",q:"답변3"},{f:"단체 신청은 어떻게 하면 되나요?",q:"답변4"},{f:"반려동물도 함께 참석이 가능한 행사인가요?",q:"답변5"}],_1=()=>{const[t,a]=i.useState(null),s=i.useRef(null),r=i.useRef(null),l=i.useRef(null),d=i.useRef(null),[p,c]=i.useState(""),h=x=>{x.current&&x.current.scrollIntoView({behavior:"smooth"})};i.useEffect(()=>{const x=[s.current,r.current,l.current,d.current],g=new IntersectionObserver(w=>{w.forEach(y=>{y.isIntersecting&&c(y.target.id)})},{threshold:.7});return x.forEach(w=>{w&&g.observe(w)}),()=>{x.forEach(w=>{w&&g.unobserve(w)})}},[]);const j=x=>{a(t===x?null:x)};return e.jsxs(e.Fragment,{children:[e.jsxs(P1,{children:[e.jsx("button",{onClick:()=>h(s),className:p==="section1"?"active":"",children:"기본 정보"}),e.jsx("button",{onClick:()=>h(r),className:p==="section2"?"active":"",children:"상세 정보"}),e.jsx("button",{onClick:()=>h(l),className:p==="section3"?"active":"",children:"FAQ"}),e.jsx("button",{onClick:()=>h(d),className:p==="section4"?"active":"",children:"문의하기"})]}),e.jsxs(T1,{children:[e.jsxs(D1,{ref:s,id:"section1",children:[e.jsx("h3",{children:"기본 정보"}),e.jsxs("ul",{className:"info_list",children:[e.jsxs("li",{className:"item",children:[e.jsx("span",{className:"tit",children:"행사 기간"}),e.jsx("span",{className:"desc",children:"2024년 09월 05일 ~ 2024년 09월 08일"})]}),e.jsxs("li",{className:"item",children:[e.jsx("span",{className:"tit",children:"개최 장소"}),e.jsx("span",{className:"desc",children:"양재 AT센터"})]}),e.jsxs("li",{className:"item",children:[e.jsx("span",{className:"tit",children:"세부 장소"}),e.jsx("span",{className:"desc",children:"제1전시장 A홀"})]}),e.jsxs("li",{className:"item",children:[e.jsx("span",{className:"tit",children:"전시 분야"}),e.jsx("span",{className:"desc",children:"농축산 · 식음료"})]}),e.jsxs("li",{className:"item",children:[e.jsx("span",{className:"tit",children:"참가 비용"}),e.jsx("span",{className:"desc",children:"사전 신청 시 무료 · 현장 구매 시 유료"})]})]})]}),e.jsxs(W1,{ref:r,id:"section2",children:[e.jsx("h3",{children:"상세 정보"}),e.jsxs("div",{className:"detail_box",children:[e.jsx("div",{className:"image",children:e.jsx("img",{src:"./dummy_detail.png"})}),e.jsx("div",{className:"more_box",children:e.jsx("p",{className:"btn",children:e.jsx("button",{children:"더보기"})})})]})]}),e.jsxs(Y1,{ref:l,id:"section3",children:[e.jsx("h3",{children:"FAQ"}),e.jsx("ul",{className:"faq_list",children:q1.map((x,g)=>e.jsxs("li",{className:"faq_item",children:[e.jsxs("div",{onClick:()=>j(g),className:"question",children:[e.jsx("span",{className:"icon",children:e.jsx(U1,{})}),e.jsx("span",{className:"txt",children:x.f})]}),t===g&&e.jsxs("div",{className:"answer",children:[e.jsx("span",{className:"icon",children:e.jsx(Q1,{})}),e.jsxs("span",{className:"txt",children:[" ",x.q]})]})]},g))})]}),e.jsxs(J1,{ref:l,id:"section4",children:[e.jsx("h3",{children:"문의하기"}),e.jsxs("ul",{className:"info_list",children:[e.jsxs("li",{className:"item",children:[e.jsx("span",{className:"tit",children:"담당자"}),e.jsx("span",{className:"desc",children:"2024 대한민국 농업박람회 운영사무국"})]}),e.jsxs("li",{className:"item",children:[e.jsx("span",{className:"tit",children:"전화번호"}),e.jsx("span",{className:"desc",children:"02-0000-0000"})]}),e.jsxs("li",{className:"item",children:[e.jsx("span",{className:"tit",children:"이메일"}),e.jsx("span",{className:"desc",children:"admin@agri.com"})]})]})]})]})]})},G1=n.div`
  /* width: 405px; */
`,X1=n.div`
  width: 100%;
  display: flex;
...
`,$1=n.div`
  ...
  background-color: rgba(41, 46, 55, 0.5);
  border-radius: 10px;
`,e2=()=>e.jsxs("div",{children:["리뷰리스트",e.jsx(H,{})]}),t2=n.div``,i2=()=>e.jsx(t2,{children:e.jsx("p",{children:"참여기업"})}),n2=()=>{const[t,a]=i.useState("review"),[s,r]=i.useState(!0);return e.jsxs(G1,{children:[e.jsxs(X1,{children:[e.jsx("button",{onClick:()=>a("review"),className:t==="review"?"active":"",children:"리뷰"}),e.jsx("button",{onClick:()=>a("company"),className:t==="company"?"active":"",children:"참여 기업"})]}),s&&e.jsxs(K1,{children:[e.jsxs("span",{children:["전시회 참여 후 리뷰를 작성해주세요.",e.jsx("br",{}),"고객님의 리뷰는 다른 사용자들에게 큰 도움이 됩니다"]}),e.jsx("button",{onClick:()=>r(!1),children:e.jsx(q,{})})]}),e.jsxs($1,{children:[t==="review"&&e.jsx(e2,{}),t==="company"&&e.jsx(i2,{})]})]})},a2=()=>e.jsxs(z1,{className:"maxframe",children:[e.jsxs(S1,{children:[e.jsxs(Z1,{children:[e.jsx(O1,{}),e.jsx(_1,{})]}),e.jsx(V1,{children:e.jsx(n2,{})})]}),e.jsx(M,{title:"AI 메이트가 맞추는 ‘OOOO’님의 취향저격 전시 ",eventList:k.eventList})]}),s2=n.div`
  position: relative;
  padding: 0 0 97px;
  margin-bottom: 100px;
  color: #fff;
...
`,E2=()=>{const[t,a]=i.useState(""),[s,r]=i.useState(!1),l=i.useRef(null),d=Z("(max-width: 1024px)"),p=()=>{r(!0),d===!0&&(document.body.style.overflow="hidden")},c=()=>{r(!1),d===!0&&(document.body.style.overflow="auto")};return e.jsx(C2,{children:e.jsxs(v2,{$filter:s,children:[e.jsx("input",{type:"text",placeholder:"방문하고싶은 부스를 검색해보세요!",onChange:h=>{a(h.target.value)},value:t,onFocus:p,onBlur:c}),e.jsx("button",{className:"search_btn",children:e.jsx(G,{})}),s&&e.jsx(k2,{ref:l,children:e.jsxs(y2,{children:[e.jsxs(P,{children:[e.jsx("span",{className:"text",children:"마인즈그라운드"}),e.jsx("button",{className:"add_btn",children:"관심부스추가"})]}),e.jsxs(P,{children:[e.jsx("span",{className:"text",children:"마인즈그라운드"}),e.jsx("button",{className:"add_btn",children:"관심부스추가"})]}),e.jsxs(P,{children:[e.jsx("span",{className:"text",children:"마인즈그라운드"}),e.jsx("button",{className:"add_btn",children:"관심부스추가"})]})]})})]})})},L2=()=>e.jsxs(w2,{children:[e.jsx(E2,{}),e.jsx(u2,{children:e.jsx("img",{src:"./booth.png"})}),e.jsx(b2,{children:e.jsx("button",{children:"AI 추천 부스 확인"})}),e.jsxs(j2,{children:[e.jsxs("div",{children:[e.jsx("p",{className:"type_title",children:"추천 부스 리스트"}),e.jsxs("ul",{className:"booth_list commend",children:[e.jsx("li",{children:"A-02 네츄럴코어"}),e.jsx("li",{children:"A-11 분독"}),e.jsx("li",{children:"B-12 메이드인랩"}),e.jsx("li",{children:"A-11 분독"}),e.jsx("li",{children:"B-12 메이드인랩"})]})]}),e.jsxs("div",{children:[e.jsx("p",{className:"type_title",children:"관심 부스 리스트"}),e.jsx("ul",{className:"booth_list wish",children:e.jsxs("li",{children:[e.jsx("span",{children:"A-02 마인즈그라운드"}),e.jsx("span",{className:"icon",children:e.jsx(q,{})})]})})]})]})]}),N2=n.div`
  position: relative;
...
`,M2=()=>e.jsxs(N2,{children:[e.jsx("div",{className:"title",children:"그 동안 서비스를 이용해주셔서 감사합니다."}),e.jsxs("div",{className:"info_box",children:["- 회원탈퇴 신청 시, 회원님 이메일 아이디로 즉시 탈퇴 처리가 진행됩니다.",e.jsx("br",{}),"- 회원가입 시, 입력한 회원정보는 모두 삭제됩니다.",e.jsx("br",{}),"- 회원탈퇴가 완료된 이메일은 본인을 포함한 타인 모두 재사용이나 복구가 불가능합니다.",e.jsx("br",{}),"- 회원탈퇴 완료 후, 삭제된 행사와 접수내역의 데이터는 복구되지 않습니다.",e.jsx("br",{}),"- 등록한 행사나 참가한 행사 중에 진행중인 행사가 있을 시, 탈퇴가 불가능합니다. 행사 내역 삭제나 취소를 후에 탈퇴 부탁드립니다."]}),e.jsx("div",{className:"chk_wrap",children:e.jsx(K,{label:"안내사항을 모두 확인하였으며, 이에 동의합니다.",id:"agree01"})}),e.jsxs("div",{className:"btn_area",children:[e.jsx("span",{className:"err_txt",children:"참가한 행사가 존재합니다. [마이페이지 >신청 행사 내역]에서 취소해주세요."}),e.jsx(o,{to:"/with-draw-finish",children:"탈퇴하기"})]})]}),H2=n.div`
  min-height: 70vh;
  padding-top: 200px;
  @media (max-width: 1024px) {
    min-height: 80vh;
...
`,z2=()=>e.jsx(H2,{children:e.jsxs("p",{className:"desc_box",children:[e.jsx("span",{children:"탈퇴가 완료되었습니다."}),e.jsx("span",{children:"그 동안 서비스를 이용해주셔서 감사합니다."}),e.jsx(o,{to:"/",children:"홈으로 돌아가기"})]})}),S2=n.form`
  max-width: 584px;
  width: 100%;
  margin: 0 auto;
  height: 100vh;
...
`,B2=t=>i.createElement("svg",{width:48,height:48,viewBox:"0 0 48 48",fill:"none",xmlns:"http://www.w3.org/2000/svg",...t},i.createElement("g",{clipPath:"url(#clip0_759_23108)"},i.createElement("path",{d:"M10.8359 46.3285C9.67787 46.9226 8.36387 45.8815 8.59787 44.5525L11.0879 30.3625L0.518867 20.2945C-0.468133 19.3525 0.0448665 17.6305 1.36787 17.4445L16.0619 15.3565L22.6139 2.37555C23.2049 1.20555 24.8039 1.20555 25.3949 2.37555L31.9469 15.3565L46.6409 17.4445C47.9639 17.6305 48.4769 19.3525 47.4869 20.2945L36.9209 30.3625L39.4109 44.5525C39.6449 45.8815 38.3309 46.9226 37.1729 46.3285L23.9999 39.5606L10.8329 46.3285H10.8359Z",fill:"#555555"})),i.createElement("defs",null,i.createElement("clipPath",{id:"clip0_759_23108"},i.createElement("rect",{width:48,height:48,fill:"white"})))),I2=()=>{const t=["first","second","third","fourth","five"],[a,s]=i.useState(0);return console.log(a),e.jsx(A2,{children:t.map((r,l)=>e.jsx(R2,{onClick:()=>s(l+1),className:a>l?"fill":"stroke",children:e.jsx(B2,{})},r))})},F2=n.div`
  width: 100%;
  border: 1px solid #fff;
  border-radius: 10px;
  background-color: transparent;
...
`,O2=({placeholder:t})=>e.jsx(F2,{children:e.jsx("textarea",{placeholder:t})}),P2=()=>e.jsxs(S2,{children:[e.jsx(Z2,{children:e.jsx("img",{src:"./dummy_image_01.png"})}),e.jsxs(V2,{children:[e.jsxs("div",{className:"text_box",children:[e.jsx("span",{children:"ㅇㅇㅇ님, 참여한 행사는 어떠셨나요?"}),e.jsx("span",{children:"리뷰를 남겨주시면 더 좋은 행사를 준비하는데에 큰 도움이 될 수 있어요!"})]}),e.jsx(I2,{}),e.jsx("div",{className:"input_text_area",children:e.jsx(O2,{placeholder:"참여한 행사에 대해 더 남겨주실 의견이 있으신가요?"})}),e.jsx("div",{className:"submit_area",children:e.jsx("button",{children:"리뷰 남기기"})})]})]}),T2=[{id:1,gubun:"메인",name:"메인페이지",link:"/"},{id:2,gubun:"메인",name:"메인페이지 > 검색",link:"/list"}],D2=[{id:3,gubun:"로그인&회원가입",name:"로그인",link:"/login"},{id:4,gubun:"로그인&회원가입",name:"로그인 > 비밀번호 찾기",link:"/login/password-find"},{id:5,gubun:"로그인&회원가입",name:"회원가입",link:"/join"},{id:6,gubun:"로그인&회원가입",name:"회원가입 > 이메일 회원가입",link:"/join/form"}],W2=[{id:7,gubun:"마이페이지",name:"마이페이지 > 참여 행사관리 > 신청 행사",link:"/mypage/apply-list"},{id:8,gubun:"마이페이지",name:"마이페이지 > 참여 행사관리 > 신청 행사 > 부스 선택",link:"/mypage/apply-list/booth-select/01"},{id:9,gubun:"마이페이지",name:"마이페이지 > 참여 행사관리 > 신청 행사 > AI 추천 부스 받기",link:"/mypage/apply-list/booth-check/01"},{id:10,gubun:"마이페이지",name:"마이페이지 > 참여 행사관리 > 취소 내역",link:"/mypage/cancel-list"},{id:11,gubun:"마이페이지",name:"마이페이지 > 참여 행사관리 > 관심 행사",link:"/mypage/wish-list"},{id:12,gubun:"마이페이지",name:"마이페이지 > 참여 행사관리 > 지난 행사",link:"/mypage/past-list"},{id:13,gubun:"마이페이지",name:"마이페이지 > 내 정보 수정",link:"/mypage/user-modify"},{id:14,gubun:"마이페이지",name:"마이페이지 > 내 정보 수정 > 탈퇴",link:"/mypage/user-modify/with-draw"},{id:15,gubun:"마이페이지",name:"마이페이지 > 내 정보 수정 > 탈퇴 > 완료",link:"/with-draw-finish"}],Y2=[{id:16,gubun:"행사 상세페이지",name:"행사 상세페이지",link:"/detail/01",ing:"작업중"},{id:17,gubun:"행사 상세페이지",name:"행사 상세페이지 > 신청하기(개인신청)",link:""},{id:18,gubun:"행사 상세페이지",name:"행사 상세페이지 > 신청하기(단체신청)",link:""},{id:19,gubun:"행사 상세페이지",name:"행사 상세페이지 > 신청하기 > 신청완료",link:""}],J2=[{id:20,gubun:"리뷰",name:"리뷰 남기기",link:"/edit-review"}],U2=[{id:21,gubun:"이용약관",name:"개인정보 수집 동의",link:""},{id:22,gubun:"이용약관",name:"개인정보처리방침",link:""},{id:23,gubun:"이용약관",name:"마케팅정보 제3자 동의",link:""},{id:24,gubun:"이용약관",name:"서비스 이용약관",link:""}],v={main:T2,loginJoin:D2,myPage:W2,eventDetail:Y2,review:J2,agree:U2},Q2=n.div`
  padding: 40px 20px;
  & h1 {
    font-size: 18px;
    padding: 10px;
...
`;function K2(){return e.jsxs(e.Fragment,{children:[e.jsx(X2,{}),e.jsx(G2,{})]})}Ne(document.getElementById("root")).render(e.jsx(He,{children:e.jsx(K2,{})}));
